...
(function() {
  var HOTPOOR_CDN_PREFIX, HOTPOOR_CDN_PREFIX_AUDIO, HOTPOOR_CDN_PREFIX_VIDEO, aim_ad_id, aim_ad_members, bangfer_app, bangfer_init, bangfer_log, bangfer_print, bangfer_ws, getQueryVariable, root;
  ...
  bangfer_init = function(bangfer_app) {
    ...
    $.ajax({
      ...
      "success": function(data) {
        ...
        return console.log(aim_ad_members);
      },
      "error": function(data) {
