...
(function() {
  var HOTPOOR_CDN_PREFIX, HOTPOOR_CDN_PREFIX_AUDIO, HOTPOOR_CDN_PREFIX_VIDEO, aim_ad_id, aim_ad_members, aim_ad_open, bangfer_app, bangfer_init, bangfer_log, bangfer_print, bangfer_ws, boss_user_id, formatDate, getQueryVariable, help_user_id, iphone_color_info, iphone_info, iphone_share_info, iphone_size_info, root,
  ...
  $("body").on("click", ".select_color_btn", function(evt) {
  ...
  $("body").on("click", ".select_size_btn", function(evt) {
    ...
    return $.ajax({
      ...
      success: function(data) {
        ...
        if (data.info === "update") {
          ...
          setTimeout(function() {
            return $("#iphone_kan_cover").fadeOut(1000, function() {
