...
(function() {
  var HOTPOOR_CDN_PREFIX, HOTPOOR_CDN_PREFIX_AUDIO, HOTPOOR_CDN_PREFIX_VIDEO, aim_ad_id, aim_ad_members, aim_ad_open, bangfer_app, bangfer_init, bangfer_log, bangfer_print, bangfer_ws, formatDate, getQueryVariable, iphone_info, root;
  ...
  $("body").on("click", ".iphone_pay_50", function(evt) {
    var boss_user_id, help_user_id, wx_pay_app, wx_pay_order_id, wx_pay_price;
    wx_pay_order_id = "";
